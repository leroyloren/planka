...
export default {
  ...
  translation: {
    common: {
      ...
      linkIsCopied: 'Odkaz je zkopírován',
      list: 'Seznam',
      listActions_title: 'Seznam akcí',
      managers: 'Vedoucí',
      managerActions_title: 'Akce vedoucí',
      members: 'Členové',
      memberActions_title: 'Akce člen',
      minutes: 'Minuty',
    ...
    action: {
      ...
      makeCover_title: 'Vytvořit náhled',
      move: 'Přesunout',
      moveCard_title: 'Přesunout kartu',
      remove: 'Odstranit',
      removeBackground: 'Odstranit pozadí',
      removeCover_title: 'Odstranit náhled',
